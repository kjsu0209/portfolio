...
const timelinesection = [
  {
    heading: "Technology University Dublin",
    image: "./assets/images/education-page/timeline-1.svg",
    subheading:"Bachelors of Science, Computer Science, (2019-2020)",
    description: "<li>Studied computer science modules in year 3.</li><li>Participate K-EU dual degree program and finished all process successfully.</li>",
  },

  {
    heading: "Kyungpook National University",
    image: "./assets/images/education-page/timeline-1.svg",
    subheading:"Bachelors of Science, Computer Science & Engineering, (2017-2021.2)",
    description: "<li>Earned scholarship from school program during whole period.</li>",
  },

  {
    heading: "Gangdong High School",
    image: "./assets/images/education-page/timeline-1.svg",
    subheading:"(2014-2017)",
    description: "<li>Join broadcast society and lead the society as a primary PD.</li>",
  },
